...
cfcEntityStubber.registerStub( "m9k_g3a3", function( weapon )
    weapon.Purpose = ""
...
cfcEntityStubber.registerStub( "m9k_m16a4_acog", function( weapon )
    weapon.Purpose = ""
    weapon.CFC_Category = "Rifle:Battle"
...
cfcEntityStubber.registerStub( "m9k_fal", function( weapon )
    weapon.Purpose = ""
    weapon.CFC_Category = "Rifle:Battle"
...
cfcEntityStubber.registerStub( "m9k_scar", function( weapon )
    weapon.Purpose = ""
    weapon.CFC_Category = "Rifle:Battle"
