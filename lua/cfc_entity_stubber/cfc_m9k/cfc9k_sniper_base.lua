...
cfcEntityStubber.registerStub( "m9k_m24", function( weapon )
    weapon.Purpose = ""
...
cfcEntityStubber.registerStub( "m9k_remington7615p", function( weapon )
    weapon.Purpose = ""
    weapon.CFC_Category = "Sniper:Base"
...
cfcEntityStubber.registerStub( "m9k_contender", function( weapon )
    weapon.Purpose = ""
    weapon.CFC_Category = "Sniper:Base"
