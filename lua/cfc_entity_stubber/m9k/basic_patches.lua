...
applyBasicPatch( "m9k_famas",
    ...
    { Damage = 25, KickUp = 2.25, KickDown = 2.25, KickHorizontal = 0.2, },
    -- og: { KickUpMultiplier = 2, }
    { KickUpMultiplier = 1.5, Scoped = true, Instructions = "Strong, if you can handle the recoil.", }
...
applyBasicPatch( "m9k_fal",
    ...
    { Automatic = true, Instructions = "High damage, high spread.\nNow starts in full-auto!", }
)
...
applyBasicPatch( "m9k_m14sp",
    ...
    { ClipSize = 15, SpreadHip = 0.005, SpreadIronSights = 0.001, KickUp = 1.8, KickDown = 2, KickHorizontal = 2, },
...
applyBasicPatch( "m9k_honeybadger",
    ...
    { Damage = 16, SpreadHip = 0.015, SpreadIronSights = 0.0125, }
)
