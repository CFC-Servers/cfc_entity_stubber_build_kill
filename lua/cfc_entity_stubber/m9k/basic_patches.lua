...
applyBasicPatch( "m9k_g36", { Damage = 25, RPM = 400, SpreadHip = 0.0125, SpreadIronSights = 0.01, KickUp = 0.6, KickDown = 0.5, KickHorizontal = 0.4, }, { Instructions = "Slower, but more accurate.", } )
